...
categories:
  - 前端
description: "看过不少人的回答。有的人写了很多，密密麻麻的堪比教科书。像这类文章，我是看不下去，至少放点图或者代码来丰富一下文章。因为，我觉得真的理解一个知识点的人，脑袋里肯定有张图，或者表格。当你写博客的时候，就是对着脑袋里的图，看图写话。这样写出来的博客，怎么可能不配几张图，或者几段代码呢！除非博客的内容就一页多，这样还可以接受。<!--more-->"
---
# 序
